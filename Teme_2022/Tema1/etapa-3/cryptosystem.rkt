...
; Verific daca elementul apartine intervalului [1, 26], caz in care am literele
; de la a la z. Adaug 96 pentru a ajunge la codurile ASCII ale literelor de la
; a la z si ulterior, voi face conversia din cod ASCII in caracter.
; In urma operatiilor, o sa obtin o lista de caractere, pe care o voi converti
; la sir de caractere.
...
; Am creat functia generala conversion, care primeste un mesaj,
; reprezentat sub forma unei liste de coduri, o cheie si o operatie (+/-).
; Voi aplica formula pentru criptare / decriptare asupra mesajului,
; reprezentat sub forma unei liste de coduri si asupra cheii extinse.
...
; Intai convertesc mesajul clar reprezentat de un sir de caractere
; in lista de coduri. Aplic functia construita anterior encrypt-codes asupra
; listei de coduri si asupra cheii. Pentru a intoarce un sir de caractere,
; convertesc lista de coduri folosind functia codes->message.
(define encrypt-message
  (λ(codes key) (codes->message (encrypt-codes (message->codes codes) key))))

; Procedez similar ca la encrypt-message, doar ca voi converti mesajul criptat
; in lista de coduri si voi aplica in schimb functia decrypt-codes asupra
; listei de coduri si asupra cheii.
